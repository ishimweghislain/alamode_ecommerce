...
export default function DocumentationPage() {
    const sections = [
        ...
        },
        {
            ...
            icon: HelpCircle,
            content: "If you have questions or encounter any issues, please reach out to our support team via email at mugisha@programage.com, call us on 0789054955, or use the Support ticket system in your dashboard.",
        }
    ];
