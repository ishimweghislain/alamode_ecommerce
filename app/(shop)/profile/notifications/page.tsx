...
export default function ProfileNotificationsPage() {
    ...
    const handleSync = async () => {
        ...
        try {
            ...
            toast.success(`Synchronized your signals.`);
        ...
        <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-4xl font-black text-white uppercase tracking-tighter">Your <span className="text-brand-gold italic">Signals.</span></h1>
                        <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px] mt-1">Updates on your orders and support tickets.</p>
                    </div>
                </div>
                <button
                    onClick={handleSync}
                ...
                >
                    ...
                    {isSyncing ? "Updating..." : "Refresh Status"}
                </button>
            </div>
