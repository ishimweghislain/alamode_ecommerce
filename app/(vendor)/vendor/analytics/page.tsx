...
export default async function VendorAnalyticsPage() {
    try {
                            ...
                            <div key={product.id} className="flex items-center justify-between p-4 bg-white/5 border border-white/5 rounded-luxury">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-400">{product._count?.orderItems || 0} Sales Recorded</p>
                                    </div>
                                </div>
        ...
        console.error("[VENDOR_ANALYTICS_PAGE_ERROR]", error);
        return (
            <div className="card-luxury p-12 text-center space-y-6">
                ...
                <p className="text-gray-400 max-w-sm mx-auto">We encountered an issue calculating your store growth metrics. Please refresh the page.</p>
                <Link href="/vendor/analytics" className="btn-primary px-8 py-3 inline-block">Retry Diagnostics</Link>
            </div>
        );
    }
}
