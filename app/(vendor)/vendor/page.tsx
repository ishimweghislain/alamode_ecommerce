            ...
            <div className="flex flex-col items-center justify-center min-h-[80vh] text-center max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <div className="space-y-4">
                    <h1 className="text-4xl font-outfit font-bold text-white leading-tight">
                        {vendor ? "Application Under Review" : "Store Access Denied"}
                    </h1>
                    <p className="text-gray-400 text-lg">
                        {vendor
                            ? "Your vendor application has been received and is currently being reviewed by our luxury curation team. You will be notified once your store is activated."
                            : "You must be an approved vendor to access this proprietary marketplace portal."}
                    </p>
                </div>

                <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
                    {!vendor && (
                        <Link href="/vendors/apply" className="btn-primary px-10 py-4 h-auto text-base">
                            Apply to Become a Vendor
                        </Link>
                    )}
                    <Link href="/" className="bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-white/20 px-10 py-4 rounded-luxury transition-all text-base">
                        Back to Marketplace
                    </Link>
                </div>
