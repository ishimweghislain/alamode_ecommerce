...
const LogoutModal = ({ isOpen, onClose }: LogoutModalProps) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div
                className="absolute inset-0 bg-black/40 backdrop-blur-md transition-all duration-300 pointer-events-auto"
                onClick={onClose}
            />

            {/* Modal Container */}
            <div className="relative w-full max-w-sm transform transition-all duration-500 animate-in zoom-in-95 fade-in duration-300">
                <div className="bg-background-dark/90 border border-white/10 p-8 rounded-[2rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden">
                    {/* Decorative Elements */}
                    ...
                    <div className="absolute -top-12 -left-12 w-32 h-32 bg-brand-accent/10 rounded-full blur-3xl" />
                    <div className="absolute -bottom-12 -right-12 w-32 h-32 bg-brand-gold/10 rounded-full blur-3xl" />

                    {/* Content */}
                    <div className="relative z-10">
                        <div className="h-20 w-20 bg-gradient-to-tr from-red-500/20 to-red-500/5 rounded-2xl flex items-center justify-center mx-auto mb-8 rotate-12 group hover:rotate-0 transition-transform duration-500 border border-red-500/20">
