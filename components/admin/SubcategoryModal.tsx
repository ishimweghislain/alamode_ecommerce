...
export default function SubcategoryModal({ isOpen, onClose, categoryId, initialData }: SubcategoryModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative bg-background-dark/95 border border-white/10 rounded-[2rem] w-full max-w-sm overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
